...
json_file = open(r'F:\Vikas\faceemotionrecognition\Face-Emotion-Recognition-main\realtimefaceemotionrecognition\model1.json', 'r')
...
#load face
try:
    face_cascade = cv2.CascadeClassifier(r"F:\Vikas\faceemotionrecognition\Face-Emotion-Recognition-main\realtimefaceemotionrecognition\haarcascade_frontalface_default2.xml")
except Exception:
